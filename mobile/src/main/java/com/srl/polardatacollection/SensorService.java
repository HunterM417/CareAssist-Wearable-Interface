...
//            System.out.println(Float.toString(magneticMatrix[0]) + "," + Float.toString(magneticMatrix[1]) + "," + Float.toString(magneticMatrix[2])); // x, y, z
    ...
    public void save_file(String[] coordinates, String filename) {
        ...
        try {
            ...
            if (!fileExists){
                writer.write("Time,AccelerometerX,AccelerometerY,AccelerometerZ,GyroscopeX,GyroscopeY,GyroscopeZ,GravityX,GravityY,GravityZ,MagneticX,MagneticY,MagneticZ,Activity");
                writer.newLine();
            }
